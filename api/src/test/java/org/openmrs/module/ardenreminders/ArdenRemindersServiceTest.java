...
import org.openmrs.module.ardenreminders.api.impl.ArdenRemindersServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in ArdenRemindersService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class ArdenRemindersServiceTest {
	
	@InjectMocks
	ArdenRemindersServiceImpl basicModuleService;
